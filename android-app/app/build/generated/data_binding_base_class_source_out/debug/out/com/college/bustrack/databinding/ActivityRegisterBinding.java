...
public final class ActivityRegisterBinding implements ViewBinding {
  ...
  private ActivityRegisterBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull TextInputEditText etUsername, @NonNull MaterialCardView headerCard,
      @NonNull ProgressBar progressBar, @NonNull RadioButton rbDriver,
      @NonNull RadioButton rbStudent, @NonNull RadioGroup rgRole, @NonNull TextView tvLoginLink) {
  ...
  public static ActivityRegisterBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityRegisterBinding((ConstraintLayout) rootView, btnRegister, etEmail, etName,
          etPassword, etUsername, headerCard, progressBar, rbDriver, rbStudent, rgRole,
          tvLoginLink);
    }
